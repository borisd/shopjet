...
function shopjet_shared(e) {
	...
	$(e.target.parentNode.parentNode).append('<iframe frameborder="0" width="380" height="100" src="http://127.0.0.1:8000/generate_tracking/?storeURL=' + store_url + '&tracking_id=' + tracking_id + '">');
}
